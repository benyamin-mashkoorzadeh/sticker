...
import {addToCart, decreaseCart, getTotals, removeFromCart, selectAll} from "../slices/cartSlice.js";
                            ...
                            {cart.map((item) => (
                                ...
                                >
                                    ...
                                    <td className="font-primary font-medium px-4 sm:px-6 py-4">
                                       <QtyInput decrementQty={() => handleDecreaseCart(item)} qty={item.cartQty} incrementQty={() => handleAddToCart(item)}/>
                                    </td>
