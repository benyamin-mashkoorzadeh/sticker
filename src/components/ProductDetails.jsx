...
import {useGetProductQuery} from "../slices/productApi.js";
...
const ProductDetails = () => {
    ...
    return (
        <div
            className="flex flex-col align-middle justify-center items-center md:flex-row md:items-start space-y-8 md:space-y-0 md:space-x-4 lg:space-x-8 max-w-6xl w-11/12 mx-auto">
            {isSuccess ? (
                <>
                    <Helmet>
                    ...
                    <div
                        className="w-full md:w-1/2 max-w-md border border-palette-lighter bg-white rounded shadow-lg ml-5">
                        <div className="relative h-96">
                            <img
                                src={`http://localhost:8000/images/${product.sticker}`}
